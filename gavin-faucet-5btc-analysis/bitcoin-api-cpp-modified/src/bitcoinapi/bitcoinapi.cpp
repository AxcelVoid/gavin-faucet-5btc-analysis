...
BitcoinAPI::BitcoinAPI(const string& blockchain, const string& user, const string& password, const string& host, int port, int httpTimeout)
...
//	std::cout << result.toStyledString() << std::endl;
	...
	if ( blockchain == "btg" ) {
		ret.nonce = result["nonceUint32"].asUInt();
	} else {
